    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Move the current state by latency ms
          ...
          for (int ii = 0; ii < ptsx.size(); ii = ii + 1) {
            ...
            // Set the current heading as the reference
            ptsx[ii] = (shift_x * cos(-psi) - shift_y * sin(-psi));
            ptsy[ii] = (shift_x * sin(-psi) + shift_y * cos(-psi));
          }
          ...
          // Fit path with 3rd degree polynomial
          auto coeffs = polyfit(ptsx_transform, ptsy_transform, 3);

          // Calculate CTE and EPSI
          // CTE: This is an approximation, we should actually trace the perpendicular from x=0 to the polynomial
          ...
          */          
          ...
          double step = 2.5;
          int num_points = 25;
          for (int i = 1; i < num_points; i = i + 1) {
